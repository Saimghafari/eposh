    ...
    const productsDrawer = (
        <Box sx={{ width: { xs: 250, sm: 400, md: 400, lg: 400 }, mt: 3, ml: 3, mr: 3, }} role="presentation" onClick={toggleDrawerOpen(false)}>
            ...
            <Box sx={{ mt: 4, }}>
                ...
                <Box >
                    <Link href='/cart'><Button fullWidth sx={{ backgroundColor: '#d2a857', textTransform: 'none', fontSize: '1.2rem', fontWeight: 'bold', py: 1, borderRadius: 50, color: 'white', mt: 3, mb: 4, }}>
                        Go to payment
                    </Button>
                    </Link>
                </Box>
